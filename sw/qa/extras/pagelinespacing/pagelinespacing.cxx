...
void SwPageLineSpacingTest::checkTextAlignedToBaselineGrid(const bool bAligned)
{
    ...
    while (pNextFrame)
    {
        // Check the text alignment inside text frames.
        ...
        // Check also the content of text frames.
                                                           ...
                                                           const bool bAligned)
{
    ...
    // All other lines should have a line height which is a multiplier of the grid distance
